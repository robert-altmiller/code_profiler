...
- The __'python_class_scopes'__ is used to specify the Python classes and Python code frameworks that have the functions defined that need to be decorated with the @timer Python decorator.
