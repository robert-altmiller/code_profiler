...
def add_timer_to_all_functions(globals, log_file_path):
    ...
    globals, nb_class_results = apply_timer_decorator_to_all_nb_class_functions(globals, python_class_scopes, log_file_path = log_file_path) # nb_class_results is first
    globals, python_class_results = apply_timer_decorator_to_all_python_class_functions(globals, python_class_scopes, nb_class_results, log_file_path = log_file_path) # python_class_results is second
