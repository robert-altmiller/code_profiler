...
The returned answer should only be the correctly formatted optimized function.  DO NOT INCLUDE ANY EXPLANATIONS!!

Here is the code below to optimize, and remember, the returned answer is only the correctly formatted optimized function:\n\n
'''