...
The returned answer should only be the optimized function definition like in the example below. Do not include ```Python ``` in the returned result.
...
Here is the code below to optimize, and remember, the returned answer is only the optimized function definition and other requirements above:\n\n
'''