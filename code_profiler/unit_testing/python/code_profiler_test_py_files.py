...
globals, functions_results = apply_timer_decorator_to_all_python_functions(globals()) # python standalone functions 
...
# Write Code Profiling Results to Delta Table
create_code_profiling_results_delta_table(
    spark = spark_local,
    catalog = "hive_metastore", 
    schema = "default", 
    table_name = "code_profiler_test_py_files_in_python_file",
